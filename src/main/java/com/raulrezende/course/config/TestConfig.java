...
import com.raulrezende.course.entities.Payment;
...
import com.raulrezende.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		o1.setPayment(pay1);
		// No pedido, atribui-se um Payment, no caso pay1
		orderRepository.save(o1);
		// Após atribuir um Payment ao Order, salvamos novamente
