...
@Entity
@Table(name="tb_order") // Nome dado a tabela no banco de dados
public class Order implements Serializable {
	...
	@JoinColumn(name="client_id") // Nome da chave estrangeira no banoc de dados
	private User client;
	...
	// vem classe Payment, da variável Order order
